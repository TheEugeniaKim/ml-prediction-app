...
<figure class="${"svelte-1kk9opm"}"><img alt="${"Pfizer-Logo"}" src="${"pfizer-logo.png"}" class="${"svelte-1kk9opm"}">
	<figcaption>Pfizer INC: Working for a healthier world</figcaption></figure>

<p class="${"svelte-1kk9opm"}"><strong>Check out our data by clicking on the machine leanring view</strong></p>`;
});
...
const css$3 = {
	code: ".navbar.svelte-1dndort.svelte-1dndort{position:relative;display:flex;justify-content:space-between;align-items:center;padding:0.5rem 2rem;z-index:1;width:100%;border-bottom:solid 1px var(--primary-color);opacity:0.9;margin-bottom:1rem;background-color:#0070BF;filter:drop-shadow(15px 3px 4px #434343)\n  }.navbar.svelte-1dndort ul.svelte-1dndort{display:flex;list-style-type:none}.navbar.svelte-1dndort a.svelte-1dndort{color:#fff;padding:0.45rem;margin:0 2rem}.navbar.svelte-1dndort a.svelte-1dndort:hover{color:#00AFF0}",
	map: "{\"version\":3,\"file\":\"Nav.svelte\",\"sources\":[\"Nav.svelte\"],\"sourcesContent\":[\"<script>\\n  export let view;\\n\\n\\n</script>\\n\\n<style>\\n  .navbar {\\n    position: relative;\\n    display: flex;\\n    justify-content: space-between;\\n    align-items: center;\\n    padding: 0.5rem 2rem;\\n    z-index: 1;\\n    width: 100%;\\n    border-bottom: solid 1px var(--primary-color);\\n    opacity: 0.9;\\n    margin-bottom: 1rem;\\n    background-color: #0070BF;\\n    filter: drop-shadow(15px 3px 4px #434343)\\n  }\\n\\n  .navbar ul {\\n    display: flex;\\n    list-style-type: none;\\n  }\\n\\n\\n  .navbar a {\\n    color: #fff;\\n    padding: 0.45rem;\\n    margin: 0 2rem;\\n  }\\n\\n  .navbar a:hover {\\n    color: #00AFF0;\\n  }\\n\\n</style>\\n\\n<div class=\\\"navbar\\\">\\n\\n  <ul>\\n    <li> <a class='{view === undefined ? \\\"selected\\\": \\\"\\\"}' href='.'> Home </a></li>\\n    <li> <a class='{view === \\\"about\\\" ? \\\"selected\\\": \\\"\\\"}' href='about'> About </a></li>\\n    <li> <a class='{view === \\\"machine-learning\\\" ? \\\"selected\\\": \\\"machine-learning\\\"}' href='machine-learning'> Machine Learning View </a></li>\\n  </ul>\\n</div>\"],\"names\":[],\"mappings\":\"AAOE,OAAO,8BAAC,CAAC,AACP,QAAQ,CAAE,QAAQ,CAClB,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,CAC9B,WAAW,CAAE,MAAM,CACnB,OAAO,CAAE,MAAM,CAAC,IAAI,CACpB,OAAO,CAAE,CAAC,CACV,KAAK,CAAE,IAAI,CACX,aAAa,CAAE,KAAK,CAAC,GAAG,CAAC,IAAI,eAAe,CAAC,CAC7C,OAAO,CAAE,GAAG,CACZ,aAAa,CAAE,IAAI,CACnB,gBAAgB,CAAE,OAAO,CACzB,MAAM,CAAE,YAAY,IAAI,CAAC,GAAG,CAAC,GAAG,CAAC,OAAO,CAAC;EAC3C,CAAC,AAED,sBAAO,CAAC,EAAE,eAAC,CAAC,AACV,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,IAAI,AACvB,CAAC,AAGD,sBAAO,CAAC,CAAC,eAAC,CAAC,AACT,KAAK,CAAE,IAAI,CACX,OAAO,CAAE,OAAO,CAChB,MAAM,CAAE,CAAC,CAAC,IAAI,AAChB,CAAC,AAED,sBAAO,CAAC,gBAAC,MAAM,AAAC,CAAC,AACf,KAAK,CAAE,OAAO,AAChB,CAAC\"}"
};
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"navbar svelte-1dndort"}"><ul class="${"svelte-1dndort"}"><li><a class="${escape(null_to_empty(view === undefined ? "selected" : "")) + " svelte-1dndort"}" href="${"."}">Home </a></li>
    <li><a class="${escape(null_to_empty(view === "about" ? "selected" : "")) + " svelte-1dndort"}" href="${"about"}">About </a></li>
    <li><a class="${escape(null_to_empty(view === "machine-learning"
	? "selected"
	: "machine-learning")) + " svelte-1dndort"}" href="${"machine-learning"}">Machine Learning View </a></li></ul></div>`;
});
