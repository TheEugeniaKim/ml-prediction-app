...
export const ignore = [/^\/stores\/?$/, /^\/blog.json$/, /^\/blog\/([^\/]+?).json$/];
...
export const components = [
	...
	{
		js: () => import("../../../routes/machine-learning.svelte"),
		css: "__SAPPER_CSS_PLACEHOLDER:machine-learning.svelte__"
	},
	{
		js: () => import("../../../routes/temp-cam.svelte"),
		css: "__SAPPER_CSS_PLACEHOLDER:temp-cam.svelte__"
	},
	{
...
if (typeof window !== 'undefined') {
	import("/Users/eugeniakim/Learning_Code/ml-prediction-app/node_modules/sapper/sapper-dev-client.js").then(client => {
